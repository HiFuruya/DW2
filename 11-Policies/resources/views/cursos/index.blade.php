...
@extends('templates.middleware', ['titulo' => "Curso", 'rota' => "cursos.create"])
                    ...
                    @foreach ($cursos as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                @endcan
                                @can('view', $item)
                                    <a nohref style= "cursor:pointer" onclick="showInfoModal(['CURSO: {{ $item->nome }}', 'SIGLA: {{ $item->sigla }}', '{{ $item->tempo }} ANOS', 'EIXO: {{ $item->eixo->nome }}'])" class="btn btn-primary">
