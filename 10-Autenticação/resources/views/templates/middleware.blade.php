...
<html lang="pt-br">
    <head>
        ...
        <title>SisColetivos - @yield('titulo')</title>
    ...
    <body>
                        ...
                        <li class="nav-item dropdown ps-2">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                @if(UserPermissions::isAuthorized('disciplinas.index'))
                                    <li><a href="{{route('disciplinas.index')}}" class="dropdown-item">Discíplinas</a></li>
                                @endif

                                @if(UserPermissions::isAuthorized('vinculos.index'))
                                    <li><a href="{{route('vinculos.index')}}" class="dropdown-item">Docência</a></li>
                                @endif
        ...
        <div class="container py-4">
            <div class="row">
                ...
                @if(isset($rota) && UserPermissions::isAuthorized($rota))
